              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-xl mx-auto">
                ...
                <div className="group flex items-start gap-4 p-4 rounded-2xl hover:bg-secondary/5 transition-all">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/972586085521" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-primary transition-colors text-lg font-medium">
                      058-6085521
                    </a>
                  </div>
                </div>
