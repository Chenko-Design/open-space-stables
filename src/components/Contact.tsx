            ...
            <div className="p-8 md:p-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-xl mx-auto">
                <div className="group flex items-start gap-4 p-4 rounded-2xl hover:bg-secondary/5 transition-all">
                  <div className="bg-primary p-3 rounded-full flex-shrink-0 group-hover:scale-110 transition-all">
                ...
                <div className="group flex items-start gap-4 p-4 rounded-2xl hover:bg-secondary/5 transition-all">
                  <a 
                    ...
                    className="bg-primary p-3 rounded-full flex-shrink-0 group-hover:scale-110 transition-all"
                  >
