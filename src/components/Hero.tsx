  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-24">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        <p className="font-handwriting font-bold text-2xl md:text-4xl text-accent mb-20 animate-fade-in-up tracking-wide" 
           style={{ 
             animationDelay: '0.2s',
             textShadow: '-2px -2px 0 hsl(var(--primary)), 2px -2px 0 hsl(var(--primary)), -2px 2px 0 hsl(var(--primary)), 2px 2px 0 hsl(var(--primary))'
           }}>
