      ...
      <div className="container mx-auto px-8 sm:px-12 md:px-16 lg:px-[128px] xl:px-[192px] 2xl:px-[256px]">
        <div className={`max-w-7xl mx-auto transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
          ...
          <div className="md:flex md:justify-center">
            ...
            <p>
              <span className="font-bold text-primary">עמותת גלאו"פ</span> הוקמה מתוך שליחות חברתית עמוקה: לאפשר לילדים, לנוער ולבוגרים המתמודדים עם קשיים מורכבים למצוא מקום שמאמין ביכולתם ובערכם. קבוצת מייסדי העמותה — יוצאי יחידות מובחרות ובכירים במשק — חברו לד"ר עופר קומרובסקי בשנת 2003 ונרתמו לעשייה חברתית.
            </p>
            <p>
              מטרותיה המרכזיות של העמותה הן לפתח ולקדם <span className="font-bold text-primary">שיטות טיפול חדשניות</span> בחווה טיפולית הפועלת בתוך הטבע, ולספק מימון ותמיכה לאנשים ולמשפחות שיכולים להפיק תועלת משמעותית מהטיפול — אך אינם יכולים לשאת בעלויותיו בעצמם.
            </p>
            <p>
