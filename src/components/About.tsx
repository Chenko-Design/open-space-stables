          ...
          <div className="md:flex md:items-stretch md:gap-10 lg:gap-12 md:justify-center">
            ...
            <div className="md:w-[450px] md:flex-shrink-0 flex items-stretch mt-8 md:mt-0 md:pt-3">
              <div className="space-y-6 text-lg md:text-xl text-foreground leading-relaxed text-right font-sans">
                ...
                <p>המרחב הפתוח הוא בית ומשפחה שבו כל אחד ואחת יכול למצוא מקום לנשום, להכיר ולאהוב את הערך שלו - לקחת את המושכות לידיים ולרכב קדימה.<span className="font-bold text-primary">בית ומשפחה</span> שבו כל אחד ואחת יכול למצוא מקום לנשום, להכיר ולאהוב את הערך שלו - לקחת את המושכות לידיים ולרכב קדימה.
                </p>
              </div>
            </div>
          </div>
