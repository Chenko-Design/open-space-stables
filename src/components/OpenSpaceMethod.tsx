            ...
            <div className="space-y-6 md:space-y-8">
              {principles.map((principle, index) => {
                ...
                return (
                  ...
                  >
                    <div className="relative bg-background/80 backdrop-blur-sm border border-border/50 rounded-2xl p-6 md:p-8 shadow-md hover:shadow-xl hover:-translate-y-1 transition-all duration-300 min-h-[280px] md:min-h-[240px]">
